...
<svg xmlns="http://www.w3.org/2000/svg" width="720" height="320" viewBox="0 0 720 320">
  <rect width="720" height="320" rx="14" fill="#e9eef5"/>
  <rect x="0" y="0" width="720" height="28" rx="14" fill="#202634"/>
  <circle cx="18" cy="14" r="4" fill="#f87171"/><circle cx="32" cy="14" r="4" fill="#fbbf24"/><circle cx="46" cy="14" r="4" fill="#34d399"/>
  <rect x="0" y="28" width="132" height="292" fill="#173b67"/>
  <text x="18" y="56" font-family="DejaVu Sans, sans-serif" font-size="12" fill="#fff" font-weight="bold">КАБИНЕТ</text>
  <text x="18" y="91" font-family="DejaVu Sans, sans-serif" font-size="11" fill="#dbeafe">Панель</text>
  <rect x="10" y="105" width="112" height="31" rx="6" fill="#18a957"/><text x="18" y="125" font-family="DejaVu Sans, sans-serif" font-size="11" fill="#fff" font-weight="bold">Касса</text>
  <text x="18" y="158" font-family="DejaVu Sans, sans-serif" font-size="11" fill="#dbeafe">Билеты</text><text x="18" y="190" font-family="DejaVu Sans, sans-serif" font-size="11" fill="#dbeafe">Возвраты</text><text x="18" y="222" font-family="DejaVu Sans, sans-serif" font-size="11" fill="#dbeafe">Отчёты</text>
  <rect x="155" y="44" width="540" height="45" rx="8" fill="#fff"/><text x="175" y="72" font-family="DejaVu Sans, sans-serif" font-size="18" fill="#173b67" font-weight="bold">Сеансы</text>
  <rect x="155" y="102" width="170" height="28" rx="5" fill="#fff" stroke="#cbd5e1"/><text x="166" y="120" font-family="DejaVu Sans, sans-serif" font-size="10" fill="#64748b">Зал</text>
  <rect x="334" y="102" width="170" height="28" rx="5" fill="#fff" stroke="#cbd5e1"/><text x="345" y="120" font-family="DejaVu Sans, sans-serif" font-size="10" fill="#64748b">Спектакль</text>
  <rect x="513" y="102" width="182" height="28" rx="5" fill="#fff" stroke="#cbd5e1"/><text x="524" y="120" font-family="DejaVu Sans, sans-serif" font-size="10" fill="#64748b">Дата</text>
  <rect x="155" y="148" width="540" height="108" rx="8" fill="#fff"/>
  <line x1="155" y1="181" x2="695" y2="181" stroke="#e2e8f0"/><text x="170" y="170" font-family="DejaVu Sans, sans-serif" font-size="10" fill="#64748b">Спектакль</text><text x="370" y="170" font-family="DejaVu Sans, sans-serif" font-size="10" fill="#64748b">Дата и время</text><text x="520" y="170" font-family="DejaVu Sans, sans-serif" font-size="10" fill="#64748b">Доступно</text>
  <text x="170" y="205" font-family="DejaVu Sans, sans-serif" font-size="11" fill="#172b4d" font-weight="bold">«10 негритят»</text><text x="370" y="205" font-family="DejaVu Sans, sans-serif" font-size="11" fill="#334155">26.09.2026 13:31</text><text x="520" y="205" font-family="DejaVu Sans, sans-serif" font-size="11" fill="#15803d">86</text>
  <rect x="600" y="188" width="78" height="28" rx="5" fill="#2563eb"/><text x="639" y="206" text-anchor="middle" font-family="DejaVu Sans, sans-serif" font-size="10" fill="#fff">Касса</text>
  <g font-family="DejaVu Sans, sans-serif" font-size="12" font-weight="bold"><circle cx="330" cy="116" r="13" fill="#dc2626"/><text x="330" y="120" text-anchor="middle" fill="#fff">1</text><circle cx="535" cy="202" r="13" fill="#dc2626"/><text x="535" y="206" text-anchor="middle" fill="#fff">2</text><circle cx="686" cy="202" r="13" fill="#dc2626"/><text x="686" y="206" text-anchor="middle" fill="#fff">3</text></g>
  <text x="155" y="286" font-family="DejaVu Sans, sans-serif" font-size="11" fill="#64748b">1 — отфильтровать сеанс  •  2 — проверить дату/доступность  •  3 — открыть кассу</text>
</svg>
SVG;

$sellScreenSvg = <<<'SVG'
<svg xmlns="http://www.w3.org/2000/svg" width="720" height="350" viewBox="0 0 720 350">
  <rect width="720" height="350" rx="14" fill="#e9eef5"/><rect x="0" y="0" width="720" height="28" rx="14" fill="#202634"/>
  <rect x="0" y="28" width="132" height="322" fill="#173b67"/><text x="18" y="61" font-family="DejaVu Sans, sans-serif" font-size="12" fill="#fff" font-weight="bold">КАССА</text><text x="18" y="101" font-family="DejaVu Sans, sans-serif" font-size="11" fill="#dbeafe">← К сеансам</text>
  <rect x="150" y="43" width="385" height="260" rx="9" fill="#fff"/><text x="170" y="68" font-family="DejaVu Sans, sans-serif" font-size="16" fill="#173b67" font-weight="bold">Схема зала</text>
  <rect x="255" y="82" width="175" height="22" rx="5" fill="#cbd5e1"/><text x="342" y="97" text-anchor="middle" font-family="DejaVu Sans, sans-serif" font-size="10" fill="#334155">СЦЕНА</text>
  <g stroke="#fff" stroke-width="2"><rect x="205" y="122" width="25" height="25" rx="4" fill="#18a957"/><rect x="236" y="122" width="25" height="25" rx="4" fill="#18a957"/><rect x="267" y="122" width="25" height="25" rx="4" fill="#ef4444"/><rect x="298" y="122" width="25" height="25" rx="4" fill="#18a957"/><rect x="329" y="122" width="25" height="25" rx="4" fill="#f59e0b"/><rect x="360" y="122" width="25" height="25" rx="4" fill="#18a957"/><rect x="391" y="122" width="25" height="25" rx="4" fill="#18a957"/><rect x="422" y="122" width="25" height="25" rx="4" fill="#18a957"/><rect x="205" y="153" width="25" height="25" rx="4" fill="#18a957"/><rect x="236" y="153" width="25" height="25" rx="4" fill="#2563eb"/><rect x="267" y="153" width="25" height="25" rx="4" fill="#18a957"/><rect x="298" y="153" width="25" height="25" rx="4" fill="#18a957"/><rect x="329" y="153" width="25" height="25" rx="4" fill="#18a957"/><rect x="360" y="153" width="25" height="25" rx="4" fill="#18a957"/><rect x="391" y="153" width="25" height="25" rx="4" fill="#ef4444"/><rect x="422" y="153" width="25" height="25" rx="4" fill="#18a957"/><rect x="205" y="184" width="25" height="25" rx="4" fill="#18a957"/><rect x="236" y="184" width="25" height="25" rx="4" fill="#18a957"/><rect x="267" y="184" width="25" height="25" rx="4" fill="#18a957"/><rect x="298" y="184" width="25" height="25" rx="4" fill="#f59e0b"/><rect x="329" y="184" width="25" height="25" rx="4" fill="#18a957"/><rect x="360" y="184" width="25" height="25" rx="4" fill="#18a957"/><rect x="391" y="184" width="25" height="25" rx="4" fill="#18a957"/><rect x="422" y="184" width="25" height="25" rx="4" fill="#18a957"/></g>
  <rect x="550" y="43" width="152" height="260" rx="9" fill="#fff"/><text x="568" y="68" font-family="DejaVu Sans, sans-serif" font-size="14" fill="#173b67" font-weight="bold">Корзина</text><text x="568" y="92" font-family="DejaVu Sans, sans-serif" font-size="10" fill="#475569">ФИО клиента</text><rect x="568" y="98" width="118" height="22" rx="4" fill="#f8fafc" stroke="#cbd5e1"/><text x="568" y="138" font-family="DejaVu Sans, sans-serif" font-size="10" fill="#475569">Телефон *</text><rect x="568" y="144" width="118" height="22" rx="4" fill="#f8fafc" stroke="#cbd5e1"/><text x="568" y="184" font-family="DejaVu Sans, sans-serif" font-size="10" fill="#475569">Тип билета</text><rect x="568" y="190" width="118" height="22" rx="4" fill="#f8fafc" stroke="#cbd5e1"/><rect x="568" y="230" width="118" height="26" rx="5" fill="#18a957"/><text x="627" y="247" text-anchor="middle" font-family="DejaVu Sans, sans-serif" font-size="10" fill="#fff">Продать</text>
  <g font-family="DejaVu Sans, sans-serif" font-size="12" font-weight="bold"><circle cx="465" cy="132" r="13" fill="#dc2626"/><text x="465" y="136" text-anchor="middle" fill="#fff">1</text><circle cx="700" cy="109" r="13" fill="#dc2626"/><text x="700" y="113" text-anchor="middle" fill="#fff">2</text><circle cx="700" cy="201" r="13" fill="#dc2626"/><text x="700" y="205" text-anchor="middle" fill="#fff">3</text><circle cx="700" cy="243" r="13" fill="#dc2626"/><text x="700" y="247" text-anchor="middle" fill="#fff">4</text></g>
  <text x="150" y="330" font-family="DejaVu Sans, sans-serif" font-size="11" fill="#64748b">1 — место  •  2 — телефон  •  3 — тип/скидка  •  4 — продажа</text>
</svg>
SVG;

$ticketsScreenSvg = <<<'SVG'
<svg xmlns="http://www.w3.org/2000/svg" width="720" height="300" viewBox="0 0 720 300">
  <rect width="720" height="300" rx="14" fill="#e9eef5"/><rect x="0" y="0" width="720" height="28" rx="14" fill="#202634"/>
  <rect x="0" y="28" width="132" height="272" fill="#173b67"/><text x="18" y="61" font-family="DejaVu Sans, sans-serif" font-size="12" fill="#fff" font-weight="bold">БИЛЕТЫ</text><text x="18" y="97" font-family="DejaVu Sans, sans-serif" font-size="11" fill="#dbeafe">Фильтры</text><text x="18" y="129" font-family="DejaVu Sans, sans-serif" font-size="11" fill="#dbeafe">Возвраты</text>
  <rect x="150" y="43" width="550" height="42" rx="8" fill="#fff"/><text x="170" y="69" font-family="DejaVu Sans, sans-serif" font-size="17" fill="#173b67" font-weight="bold">Список билетов</text>
  <rect x="150" y="98" width="165" height="25" rx="4" fill="#fff" stroke="#cbd5e1"/><text x="160" y="115" font-family="DejaVu Sans, sans-serif" font-size="10" fill="#64748b">UID / клиент</text><rect x="325" y="98" width="165" height="25" rx="4" fill="#fff" stroke="#cbd5e1"/><text x="335" y="115" font-family="DejaVu Sans, sans-serif" font-size="10" fill="#64748b">Дата / сеанс</text><rect x="500" y="98" width="200" height="25" rx="4" fill="#fff" stroke="#cbd5e1"/><text x="510" y="115" font-family="DejaVu Sans, sans-serif" font-size="10" fill="#64748b">Статус / возврат</text>
  <rect x="150" y="138" width="550" height="105" rx="8" fill="#fff"/><line x1="150" y1="169" x2="700" y2="169" stroke="#e2e8f0"/><text x="164" y="159" font-family="DejaVu Sans, sans-serif" font-size="10" fill="#64748b">Клиент</text><text x="300" y="159" font-family="DejaVu Sans, sans-serif" font-size="10" fill="#64748b">Место</text><text x="390" y="159" font-family="DejaVu Sans, sans-serif" font-size="10" fill="#64748b">Оплата</text><text x="490" y="159" font-family="DejaVu Sans, sans-serif" font-size="10" fill="#64748b">Статус</text><text x="600" y="159" font-family="DejaVu Sans, sans-serif" font-size="10" fill="#64748b">Действие</text><text x="164" y="192" font-family="DejaVu Sans, sans-serif" font-size="11" fill="#172b4d">Клиент</text><text x="300" y="192" font-family="DejaVu Sans, sans-serif" font-size="11" fill="#334155">8 / 12</text><text x="390" y="192" font-family="DejaVu Sans, sans-serif" font-size="11" fill="#15803d">Оплачен</text><text x="490" y="192" font-family="DejaVu Sans, sans-serif" font-size="11" fill="#2563eb">Выдан</text><rect x="588" y="177" width="84" height="24" rx="4" fill="#fee2e2"/><text x="630" y="193" text-anchor="middle" font-family="DejaVu Sans, sans-serif" font-size="10" fill="#b91c1c">Возврат</text>
  <g font-family="DejaVu Sans, sans-serif" font-size="12" font-weight="bold"><circle cx="285" cy="110" r="13" fill="#dc2626"/><text x="285" y="114" text-anchor="middle" fill="#fff">1</text><circle cx="510" cy="110" r="13" fill="#dc2626"/><text x="510" y="114" text-anchor="middle" fill="#fff">2</text><circle cx="683" cy="189" r="13" fill="#dc2626"/><text x="683" y="193" text-anchor="middle" fill="#fff">3</text></g>
  <text x="150" y="272" font-family="DejaVu Sans, sans-serif" font-size="11" fill="#64748b">1 — найти билет  •  2 — проверить оплату/статус  •  3 — открыть возврат</text>
</svg>
SVG;

$refundScreenSvg = <<<'SVG'
<svg xmlns="http://www.w3.org/2000/svg" width="720" height="320" viewBox="0 0 720 320">
  <rect width="720" height="320" rx="14" fill="#e9eef5"/><rect x="0" y="0" width="720" height="28" rx="14" fill="#202634"/>
  <rect x="80" y="48" width="560" height="230" rx="12" fill="#fff" stroke="#cbd5e1"/>
  <text x="108" y="82" font-family="DejaVu Sans, sans-serif" font-size="18" fill="#173b67" font-weight="bold">Возврат билета</text>
  <text x="108" y="115" font-family="DejaVu Sans, sans-serif" font-size="11" fill="#64748b">Клиент</text><rect x="108" y="121" width="210" height="25" rx="4" fill="#f8fafc" stroke="#cbd5e1"/>
  <text x="340" y="115" font-family="DejaVu Sans, sans-serif" font-size="11" fill="#64748b">Сумма</text><rect x="340" y="121" width="150" height="25" rx="4" fill="#f8fafc" stroke="#cbd5e1"/>
  <text x="108" y="174" font-family="DejaVu Sans, sans-serif" font-size="11" fill="#64748b">Метод возврата</text><rect x="108" y="180" width="210" height="25" rx="4" fill="#f8fafc" stroke="#cbd5e1"/><text x="118" y="197" font-family="DejaVu Sans, sans-serif" font-size="10" fill="#334155">Наличные / Эквайринг</text>
  <rect x="420" y="211" width="170" height="31" rx="6" fill="#dc2626"/><text x="505" y="231" text-anchor="middle" font-family="DejaVu Sans, sans-serif" font-size="11" fill="#fff">Подтвердить возврат</text>
  <g font-family="DejaVu Sans, sans-serif" font-size="12" font-weight="bold"><circle cx="326" cy="133" r="13" fill="#dc2626"/><text x="326" y="137" text-anchor="middle" fill="#fff">1</text><circle cx="502" cy="226" r="13" fill="#dc2626"/><text x="502" y="230" text-anchor="middle" fill="#fff">2</text></g>
  <text x="80" y="306" font-family="DejaVu Sans, sans-serif" font-size="11" fill="#64748b">1 — проверить клиента и сумму  •  2 — подтвердить один раз</text>
</svg>
SVG;
...
<section class="page">
    ...
    <div class="figure">__CASH_SCREEN__</div>
    <p class="caption">Экран выбора сеанса: 1 — фильтр, 2 — строка нужного сеанса, 3 — кнопка «Касса».</p>
...
<section class="page">
    ...
    <div class="figure">__SELL_SCREEN__</div>
    <p class="caption">Экран продажи: 1 — выбрать место, 2 — заполнить телефон, 3 — выбрать тип/скидку, 4 — продать.</p>
...
<section class="page">
    ...
    <div class="figure">__TICKETS_SCREEN__</div>
    <p class="caption">Экран списка билетов: 1 — поиск, 2 — проверка статуса и оплаты, 3 — действие «Возврат».</p>
...
<section class="page">
    ...
    <div class="figure">__REFUND_SCREEN__</div>
    <p class="caption">Модальное окно возврата: сначала проверьте клиента и сумму, затем подтвердите действие один раз.</p>
...
$html = str_replace(
    ['__LOGO__', '__TODAY__', '__FLOW__', '__SEATS__', '__DISCOUNTS__', '__SALE__', '__REFUND__', '__CASH_SCREEN__', '__SELL_SCREEN__', '__TICKETS_SCREEN__', '__REFUND_SCREEN__'],
    [$logo, $today, $flowSvg, $seatSvg, $discountSvg, $saleSvg, $refundSvg, $cashScreenSvg, $sellScreenSvg, $ticketsScreenSvg, $refundScreenSvg],
    $html
);
