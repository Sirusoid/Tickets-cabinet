...
$menu = [
  ...
  ['id'=>'scanner','href'=>'/scanner.php','label'=>'Сканер QR','perm'=>'tickets','icon'=>'<svg width="18" height="18" viewBox="0 0 24 24" fill="none" aria-hidden="true"><path d="M4 4h5v2H6v3H4V4zm11 0h5v5h-2V6h-3V4zM4 15h2v3h3v2H4v-5zm14 0h2v5h-5v-2h3v-3zM8 8h3v3H8V8zm5 0h3v3h-3V8zm-5 5h3v3H8v-3zm5 0h3v3h-3v-3z" fill="currentColor"/></svg>'],
