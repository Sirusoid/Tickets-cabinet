...
$menu = [
  ...
  ['id'=>'cashier_manual','href'=>'/admin/cashier_manual.php','label'=>'Руководство кассира','perm'=>'cashier_manual','icon'=>'<svg width="18" height="18" viewBox="0 0 24 24" fill="none" aria-hidden="true"><path d="M5 4.5A2.5 2.5 0 0 1 7.5 2H19v18H7.5A2.5 2.5 0 0 0 5 22.5v-18z" stroke="currentColor" stroke-width="1.5" stroke-linejoin="round"/><path d="M8 6h7M8 10h7M8 14h5" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"/></svg>'],
  ...
  ['id'=>'scanner','href'=>'/scanner.php','label'=>'Сканер QR','perm'=>'scanner','icon'=>'<svg width="18" height="18" viewBox="0 0 24 24" fill="none" aria-hidden="true"><path d="M4 4h5v2H6v3H4V4zm11 0h5v5h-2V6h-3V4zM4 15h2v3h3v2H4v-5zm14 0h2v5h-5v-2h3v-3zM8 8h3v3H8V8zm5 0h3v3h-3V8zm-5 5h3v3H8v-3zm5 0h3v3h-3v-3z" fill="currentColor"/></svg>'],
  ['id'=>'refunds','href'=>'/refunds/list.php','label'=>'Возвраты','perm'=>'refunds','icon'=>'<svg width="18" height="18" viewBox="0 0 24 24" fill="none" aria-hidden="true"><path d="M4 7h12a4 4 0 1 1-4 4H8M4 7l3-3M4 7l3 3M20 17H8a4 4 0 1 1 4-4h4M20 17l-3-3M20 17l-3 3" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/></svg>'],
  ...
  ['id'=>'error_logs','href'=>'/admin/error_logs.php','label'=>'Логи ошибок','perm'=>'error_logs','icon'=>'<svg width="18" height="18" viewBox="0 0 24 24" fill="none" aria-hidden="true"><path d="M12 3 3 20h18L12 3z" stroke="currentColor" stroke-width="1.5" stroke-linejoin="round"/><path d="M12 9v5M12 17h.01" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"/></svg>'],
];
